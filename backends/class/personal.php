    ...
    class Personal {
        ...
        function getGraphSql($id = null){
            $sql =      "SELECT `sp`.`nationalID`,
                		...
                		(50    + IFNULL(SUM(`dp`.`score`),0)) as discipline
            ...
            $sql = empty($id) ? $sql : $sql."\nAND s.instructorID = '$id'";
        ...
        function getInstructorGraphData($id) {
            ...
            if($result->num_rows > 0) {
                ...
                while($row = $result->fetch_assoc()) {
                    ...
                    $api['discipline'][($row['discipline']/50.1) * 3] += 1;
